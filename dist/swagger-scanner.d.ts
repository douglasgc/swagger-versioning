...
export declare class SwaggerScanner {
    ...
    scanModuleRoutes(routes: Map<InstanceToken, InstanceWrapper>, modulePath: string | undefined, globalPrefix: string | undefined, applicationConfig: ApplicationConfig, operationIdFactory?: (controllerKey: string, methodKey: string, versionKey: string) => string): ModuleRoute[];
