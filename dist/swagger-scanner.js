...
class SwaggerScanner {
    ...
    scanApplication(app, options) {
        ...
        const denormalizedPaths = modules.map(({ routes, metatype, relatedModules }) => {
            ...
            .map((item) => {
            if (options.includeOnlyVersion === undefined)
                return item;
            return item.filter((api) => {
                ...
                return ((_a = options.includeOnlyVersion) === null || _a === void 0 ? void 0 : _a.toString()) == (version === null || version === void 0 ? void 0 : version.toString());
            });
        });
