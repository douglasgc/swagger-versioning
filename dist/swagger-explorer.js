...
class SwaggerExplorer {
    ...
    exploreRoutePathAndMethod(instance, prototype, method, metatype, globalPrefix, modulePath, applicationConfig) {
        ...
        return allRoutePaths.map((routePath) => {
            ...
            return Object.assign({ method: common_1.RequestMethod[requestMethod].toLowerCase(), path: fullPath === '' ? '/' : fullPath, operationId: this.getOperationId(instance, method, methodVersion === null || methodVersion === void 0 ? void 0 : methodVersion.toString()) }, apiExtension);
        });
    }
    getOperationId(instance, method, pathVersion) {
        var _a;
        return this.operationIdFactory(((_a = instance.constructor) === null || _a === void 0 ? void 0 : _a.name) || '', method.name, pathVersion);
    }
